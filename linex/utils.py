...
def get_params_with_types(func: Callable) -> dict[str, Optional[list[tuple[str, Any]]]]:
    ...
    for index, param in enumerate(params):
        ...
        if this.kind.name == "KEYWORD_ONLY":
            ...
            meta["regular"].append((param, ann))

    return meta


def postback_data(name: str, *data: Any) -> str:
