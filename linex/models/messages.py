...
class Text(AbstractLineMessage):
    ...
    __slots__ = ("_text", "_emojis")
    _text: str
    _emojis: list[dict[str, Any]]

    def __init__(self, text: str, *, render_emojis: bool = True):
        emojis = []
    ...
    def to_json(self) -> dict[str, Any]:
        ...
        return {"type": "text", "text": self._text, "emojis": self._emojis or None}
...
class Sticker(AbstractLineMessage):
    ...
    def to_json(self) -> dict[str, str]:
        """Converts to a valid JSON payload."""
        return {"type": "sticker", "packageId": self._pid, "stickerId": self._sid}
...
class Video(AbstractLineMessage):
    ...
    __slots__ = ("original", "preview", "tracking")
    original: str
    preview: str
...
class Audio(AbstractLineMessage):
    ...
    __slots__ = ("original", "duration")
    original: str
    duration: int

    def __init__(self, original_content_url: str, duration: int):
        self.original = original_content_url
...
class Location(AbstractLineMessage):
    ...
    @staticmethod
    async def from_name(name: str) -> Location:
            ...
            *,
            ...
            self.json = {
                ...
                "template": {
                    ...
                    "title": title,
                    "text": text,
                    "defaultAction": default_action.to_json()
