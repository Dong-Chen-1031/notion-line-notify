...
class RepliableContext(BaseContext):
    ...
    def __init__(self, data: dict[str, Any], *args):
...
class TextMessageContext(RepliableContext):
    ...
    __slots__ = ("_text", "_id", "_emojis", "_mentions")
    _text: str
    _id: str
    ...
    def mentioned(self, user: str | User | BotUser) -> bool:
        ...
        """
        return Mention.includes_mention(self._mentions, user)
...
class ImageMessageContext(RepliableContext):
    ...
    __slots__ = ("_id", "_contentProvider", "_imageSet")
    _id: str
    ...
    async def download(
        ...
        *,
        ...
        if self.content_provider["type"] == "line":
            resp = await get_file(self.headers, self.client, self.id)
...
class VideoMessageContext(RepliableContext):
    ...
    __slots__ = ("_id", "_contentProvider", "_duration")
    _id: str
    _contentProvider: dict[str, str]
...
class FileMessageContext(RepliableContext):
    ...
    async def download(
        self, fn: Optional[str] = None, *, disable_string_parsing: bool = False
    ) -> str:
        """Downloads the file.
...
class LocationMessageContext(RepliableContext):
    ...
    __slots__ = ("_id", "_title", "_address", "_lat", "_lon")
    _id: str
    _title: Optional[str]
...
class StickerMessageContext(RepliableContext):
    ...
    __slots__ = ("_id", "_pi", "_si", "_rT", "_kw", "_text")
    _id: str
    _pi: str
    _si: str
    _rT: Literal[
