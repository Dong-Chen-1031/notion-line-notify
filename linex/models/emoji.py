...
class Emoji:
    ...
    __slots__ = ("product_id", "emoji_id", "format")
    product_id: str
    emoji_id: str
    format: str
    ...
    def to_json(self):
        ...
        return {"productId": self.product_id, "emojiId": self.emoji_id}
    ...
    @staticmethod
    def fit_on_texts(text: str, emojis: list[dict[str, Any]]) -> str:
    ...
    @staticmethod
    def emoji_text_to_emojis(text: str) -> tuple[str, list[dict[str, Any]]]:
        ...
        for match in matches:
            ...
            prev_end = end
            emojis.append(
                {"index": len(result) - 1, "emojiId": emoji_id, "productId": product_id}
            )
